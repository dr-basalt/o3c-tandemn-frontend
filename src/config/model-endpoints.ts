...
export const MODEL_ENDPOINTS: ModelEndpointConfig[] = [
  {
  ...
  {
    modelId: "btbtyler09/Devstral-Small-2507-AWQ",
...
export function getModelEndpoint(modelId: string): ModelEndpointConfig | null {
  return MODEL_ENDPOINTS.find(config => config.modelId === modelId) || null;
}

export function getAllModelEndpoints(): ModelEndpointConfig[] {
